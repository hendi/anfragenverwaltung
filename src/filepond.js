...
*/
  ...
  var defaultOptions = {
    ...
    */
    ...
    labelIdle: [
      'Sie können bis zu 3 Anhänge (jeweils max. 10MB) hochladen <span class="filepond--label-action">[Dateien auswählen]</span>',
      Type.STRING
    ],

    labelFileWaitingForSize: ['Größe wird ermittelt', Type.STRING],
    labelFileSizeNotAvailable: ['Unbekannte Größe', Type.STRING],
    labelFileCountSingular: ['Datei in Liste', Type.STRING],
    labelFileCountPlural: ['Dateien in Liste', Type.STRING],
    labelFileLoading: ['Wird geladen...', Type.STRING],
    labelFileAdded: ['Hinzugefügt', Type.STRING], // assistive only
    labelFileRemoved: ['Entfernt', Type.STRING], // assistive only
    labelFileLoadError: ['Fehler beim Laden', Type.STRING],
    labelFileProcessing: ['Wird hochgeladen...', Type.STRING],
    labelFileProcessingComplete: ['Hochladen abgeschlossen', Type.STRING],
    labelFileProcessingAborted: ['Hochladen abgebrochen', Type.STRING],
    labelFileProcessingError: ['Fehler beim Hochladen', Type.STRING],
    // labelFileProcessingPaused: ['Upload paused', Type.STRING],

    labelTapToCancel: ['Abbrechen', Type.STRING],
    labelTapToRetry: ['Wiederholen', Type.STRING],
    labelTapToUndo: ['Entfernen', Type.STRING],
    // labelTapToPause: ['tap to pause', Type.STRING],
    // labelTapToResume: ['tap to resume', Type.STRING],

    labelButtonRemoveItem: ['Entfernen', Type.STRING],
    labelButtonAbortItemLoad: ['Abbrechen', Type.STRING],
    labelButtonRetryItemLoad: ['Wiederholen', Type.STRING],
    labelButtonAbortItemProcessing: ['Abbrechen', Type.STRING],
    labelButtonUndoItemProcessing: ['Entfernen', Type.STRING],
    labelButtonRetryItemProcessing: ['Wiederholen', Type.STRING],
    labelButtonProcessItem: ['Hochladen', Type.STRING],

[%bs.raw {|require('./FolderNavigation.css')|}];

open ConversationData;

let component = ReasonReact.statelessComponent("FolderNavigation");

let make = (~active_folder, ~onClick, ~counter, _children) => {
  ...component,
  render: _self =>

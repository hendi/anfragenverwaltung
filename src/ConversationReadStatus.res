...
let make = (~conversation, ~onReadStatus: (conversation, bool) => unit) => {
  ...
  <div className="flex flex-col lg:flex-row items-center justify-center bg-white py-2 lg:py-1 px-2 hover:bg-blue-100 border cursor-pointer w-full lg:w-auto" onClick >
